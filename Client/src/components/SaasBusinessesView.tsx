      ...
      <div className={styles.pageHeader}>
        <div className={styles.pageHeaderTop}>
          <div>
            ...
            <p className={styles.pageDesc}>Supervisa los negocios en la plataforma, cambia su estado o ingresa en modo soporte.</p>
          </div>
        </div>
                  ...
                  <td>
                    <div className={styles.rowActions}>
                      <button 
                        ...
                        title="Acceder como este negocio"
                      >
                      ...
                      <button 
                        ...
                        onClick={() => alert(`Configuración rápida para: ${b.name}`)}
